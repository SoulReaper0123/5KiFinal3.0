...
const RejectedPayments = ({ payments, currentPage, totalPages, onPageChange }) => {
  ...
  if (!payments.length) {
    return (
      <div style={styles.noDataContainer}>
        ...
        <div>No rejected payments available</div>
      </div>
    );
  }
          ...
          <div style={styles.modalCard}>
            ...
            <div style={styles.modalContent}>
              <div style={styles.columnsContainer}>
                ...
                <div style={styles.column}>
                  ...
                  <div style={styles.section}>
                    ...
                    <div style={styles.fieldGroup}>
                      ...
                      <span style={styles.fieldValue}>{selectedPayment.timeRejected || 'N/A'}</span>
                    </div>
                    <div style={styles.fieldGroup}>
                ...
                {/* Right Column - Payment & Documents */}
                <div style={styles.column}>
                  <div style={styles.rejectionCard}>
                    ...
                    <div style={styles.rejectionItem}>
                      ...
                      <span style={styles.rejectionValue}>{selectedPayment.rejectionReason || 'N/A'}</span>
                    </div>
                  </div>
                  ...
                  <div style={styles.paymentCard}>
                    ...
                    <div style={styles.paymentItem}>
                      ...
                      <span style={styles.paymentValue}>{selectedPayment.transactionId || 'N/A'}</span>
                    </div>
                    <div style={styles.paymentItem}>
                      <span style={styles.paymentLabel}>Payment Method:</span>
                      <span style={styles.paymentValue}>{selectedPayment.paymentOption || 'N/A'}</span>
                    </div>
                  </div>
