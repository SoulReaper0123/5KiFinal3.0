...
import { FaCheckCircle, FaImage, FaTimes } from 'react-icons/fa';
              ...
              <div style={styles.columns}>
                <div style={styles.leftColumn}>
                  ...
                  <div style={styles.compactField}>
                    ...
                    <span style={styles.fieldValue}>{selectedDeposit?.dateApproved || 'N/A'}</span>
                  </div>
                  <div style={styles.compactField}>
                    <span style={styles.fieldLabel}>Time Approved:</span>
                    <span style={styles.fieldValue}>{selectedDeposit?.timeApproved || 'N/A'}</span>
                  </div>
                </div>
