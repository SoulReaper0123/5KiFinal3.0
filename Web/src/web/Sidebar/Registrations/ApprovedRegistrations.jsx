        ...
        <table style={styles.table}>
          <thead>
            <tr style={styles.tableHeader}>
              ...
              <th style={{ ...styles.tableHeaderCell, width: '14%' }}>Date Approved</th>
              <th style={{ ...styles.tableHeaderCell, width: '8%' }}>Action</th>
            </tr>
          </thead>
          <tbody>
            {approvedRegistrations.map((item, index) => (
              ...
              <div style={styles.columns}>
                <div style={styles.leftColumn}>
                  ...
                  <div style={styles.compactField}>
                    ...
                    <span style={styles.fieldValue}>{selectedRegistration?.dateApproved || 'N/A'}</span>
                  </div>
                  <div style={styles.compactField}>
                    <span style={styles.fieldLabel}>Time Approved:</span>
                    <span style={styles.fieldValue}>{selectedRegistration?.approvedTime || 'N/A'}</span>
                  </div>
                  <div style={styles.compactField}>
