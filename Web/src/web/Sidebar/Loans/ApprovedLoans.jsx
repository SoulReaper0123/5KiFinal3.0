...
const ApprovedLoans = ({ loans, currentPage, totalPages, onPageChange }) => {
  ...
  if (!loans.length) {
    return (
      <div style={styles.noDataContainer}>
        ...
        <div>No approved loans available</div>
      </div>
    );
  }
                ...
                <div style={styles.column}>
                  <div style={styles.loanDetailsCard}>
                    ...
                    <div style={styles.loanDetailsItem}>
                      ...
                      <span style={styles.loanDetailsValue}>{selectedLoan.term} months</span>
                    </div>
                    <div style={styles.loanDetailsItem}>
                  ...
                  <div style={styles.financialCard}>
                    ...
                    <div style={styles.financialItem}>
                      <span style={styles.financialLabel}>Due Date:</span>
                      <span style={styles.financialValue}>{selectedLoan.dueDate || 'N/A'}</span>
                    </div>
                  </div>
