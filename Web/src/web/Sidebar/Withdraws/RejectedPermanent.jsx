...
const RejectedPermanent = ({ withdraws, currentPage, totalPages, onPageChange }) => {
  ...
  if (!withdraws.length) {
    return (
      <div style={styles.loadingView}>
        <p style={styles.noDataMessage}>No rejected permanent withdrawals available.</p>
      </div>
    );
  }
...
export default RejectedPermanent;