...
const RejectedWithdraws = ({ withdraws, currentPage, totalPages, onPageChange }) => {
  ...
  if (!withdraws.length) {
    return (
      <div style={styles.noDataContainer}>
        <FaTimesCircle style={styles.noDataIcon} />
        <div>No rejected withdrawals available</div>
      </div>
    );
  }
          ...
          <div style={styles.modalCard}>
            ...
            <div style={styles.modalContent}>
              <div style={styles.columnsContainer}>
                ...
                <div style={styles.column}>
                  ...
                  <div style={styles.section}>
                    ...
                    <div style={styles.fieldGroup}>
                      ...
                      <span style={styles.fieldValue}>{selectedWithdraw.timeRejected || 'N/A'}</span>
                    </div>
                    <div style={styles.fieldGroup}>
                ...
                {/* Right Column - Withdrawal & Bank Details */}
                <div style={styles.column}>
                  <div style={styles.rejectionCard}>
                    ...
                    <div style={styles.rejectionItem}>
                      ...
                      <span style={styles.rejectionValue}>{selectedWithdraw.rejectionReason || 'N/A'}</span>
                    </div>
                  </div>
                  ...
                  <div style={styles.financialCard}>
                    ...
                    <div style={styles.financialItem}>
                      <span style={styles.financialLabel}>Withdrawal Amount:</span>
                    ...
                    <div style={styles.financialItem}>
                      ...
                      <span style={styles.financialValue}>{selectedWithdraw.transactionId || 'N/A'}</span>
                    </div>
                  </div>
