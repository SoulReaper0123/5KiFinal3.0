...
import { FaTimesCircle, FaImage, FaTimes, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
  ...
  if (!withdraws.length) {
    return (
      <div style={styles.loadingView}>
        <p style={styles.noDataMessage}>No rejected withdrawals available.</p>
      </div>
    );
  }
              ...
              <div style={styles.columns}>
                <div style={styles.leftColumn}>
                  ...
                  <div style={styles.compactField}>
                    ...
                    <span style={styles.fieldValue}>{selectedWithdraw?.dateRejected || 'N/A'}</span>
                  </div>
                  <div style={styles.compactField}>
