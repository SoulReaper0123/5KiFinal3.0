...
const SuperAdminHome = () => {
  ...
  // Build visible UI context for the AI
  const buildVisibleContext = () => {
    return `UI STATE\n- Active Section: ${activeSection}\n- Super Admin Portal: System Administration\n`;
  };
  ...
  const loadChatSessions = () => {
    try {
      const savedChats = localStorage.getItem('superAdminAIChatSessions');
      if (savedChats) {
  ...
  const saveChatSessions = (sessions) => {
    try {
      localStorage.setItem('superAdminAIChatSessions', JSON.stringify(sessions));
  ...
  const startNewChat = () => {
    ...
    const welcomeMessage = {
      type: 'ai',
      content: 'Hello Super Admin! 👑\n\nI\'m here to assist you with system administration tasks, admin management, data migration, and overall system oversight. How can I help you today?',
  ...
  const handleAIQuery = async (userMessage) => {
    ...
    try {
      console.log('Processing super admin AI query:', userMessage);
  ...
  // Enhanced professional styles matching AdminHome
  const styles = {
    container: {
      display: 'flex',
      flexDirection: 'row',
      ...
      <div style={styles.sidebar}>
        ...
        {!isCollapsed && (
          <div style={styles.scrollContainer}>
            <div style={styles.adminContainer}>
              ...
              <div style={styles.adminSubtitle}>Super Admin Portal</div>
              ...
              <div style={styles.adminButtonContainer}>
                ...
                >
                  ...
                  <span style={styles.adminButtonText}>Super Admin</span>
            ...
            <button
              ...
              style={isActive('admins') ? 
                ...
                styles.button}
              onMouseEnter={(e) => !isActive('admins') && (e.target.style.backgroundColor = 'rgba(255, 255, 255, 0.08)')}
              onMouseLeave={(e) => !isActive('admins') && (e.target.style.backgroundColor = 'transparent')}
            >
            ...
            <button
              ...
              style={isActive('dataMigration') ? 
                {...styles.button, ...styles.activeButton} : 
                styles.button}
              onMouseEnter={(e) => !isActive('dataMigration') && (e.target.style.backgroundColor = 'rgba(255, 255, 255, 0.08)')}
              onMouseLeave={(e) => !isActive('dataMigration') && (e.target.style.backgroundColor = 'transparent')}
            >
              <div style={styles.iconContainer}>
                <FaFileUpload 
        ...
        {isCollapsed && (
          <div style={styles.collapsedContainer}>
            ...
            >
              <RiAdminLine 
                style={isActive('admins') ? styles.collapsedIconActive : styles.collapsedIcon} 
                size={18}
              />
            </button>
            ...
            >
              <FaFileUpload 
                style={isActive('dataMigration') ? styles.collapsedIconActive : styles.collapsedIcon} 
                size={18}
              />
            </button>
            ...
            >
              <FaRobot style={styles.collapsedIcon} size={18} />
            </button>
          </div>
        )}
      </div>
        ...
        <div style={styles.fullOverlay}>
          <div style={styles.overlayContent}>
            ...
            <p style={styles.overlayText}>
              For optimal functionality and security, please access the Super Admin Portal from a desktop or tablet device.
            </p>
          </div>
        </div>
      )}
            ...
            <div style={styles.aiMainContent}>
              ...
              <form onSubmit={handleAIInputSubmit} style={styles.aiInputContainer}>
                <input
                  ...
                  placeholder="Ask me anything about system administration..."
