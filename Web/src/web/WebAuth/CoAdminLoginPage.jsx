...
const CoAdminLoginPage = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const adminRef = ref(database, 'Users/CoAdmin');
      ...
      if (matchedAdmin && matchedAdmin.role === 'coadmin') {
        localStorage.setItem('adminId', matchedAdmin.id);
        localStorage.setItem('isLoggedIn', 'true');
        localStorage.setItem('userRole', 'coadmin');
        login(matchedAdmin);
        navigate('/coadminhome');
      } else {
        throw new Error('Access denied. You are not an Co-Admin.');
      }
    } catch (error) {
  ...
  return (
    <div style={styles.container}>
        ...
        <div style={styles.overlay}>
          <div style={styles.overlayContent}>
            ...
            <p style={styles.overlayText}>
              For security reasons and optimal functionality, please access the Co-Admin portal from a desktop or tablet device.
            </p>
          </div>
        </div>
      )}
      ...
      <div style={styles.leftSection}>
        <div style={styles.leftSectionWrapper}>
          <div style={styles.titleBlock}>
            <h1 style={styles.title}>Co-Admin Portal</h1>
          ...
          <div style={styles.formBlock}>
            ...
            >
              {loading ? 'Signing In...' : 'Co-Admin Login'}
            </Button>
          </div>
        </div>
      </div>
      ...
      <div style={styles.rightSection}>
        ...
        <h1 style={styles.welcomeTitle}>Welcome Back, Co-Admin</h1>
        <p style={styles.welcomeSubtitle}>
          Access your co-administrative dashboard to assist with loan applications, 
          support customer accounts, and collaborate on daily banking operations.
        </p>
        ...
        <div style={styles.adminFeatures}>
          ...
          <div style={styles.featureItem}>
            <FaUserShield style={styles.featureIcon} size={16} />
            <span>Customer Account Assistance</span>
          </div>
          <div style={styles.featureItem}>
            <FaUserShield style={styles.featureIcon} size={16} />
      ...
      {loading && (
        <div style={styles.loadingOverlay}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <p style={styles.loadingText}>Authenticating Co-Admin Access...</p>
          </div>
        </div>
      )}
    </div>
...
export default CoAdminLoginPage;