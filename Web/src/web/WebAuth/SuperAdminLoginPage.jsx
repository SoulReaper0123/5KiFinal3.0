...
const SuperAdminLoginPage = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const superAdminRef = ref(database, 'Users/SuperAdmin');
      const snapshot = await get(superAdminRef);
      const superAdmins = snapshot.val();

      let matchedSuperAdmin = null;
      for (const key in superAdmins) {
        if (superAdmins[key].uid === user.uid) {
          matchedSuperAdmin = superAdmins[key];
          break;
        }
      }

      if (matchedSuperAdmin && matchedSuperAdmin.role === 'superadmin') {
        localStorage.setItem('adminId', matchedSuperAdmin.id);
        localStorage.setItem('isLoggedIn', 'true');
        localStorage.setItem('userRole', 'superadmin');
        login(matchedSuperAdmin);
    ...
    <div style={styles.container}>
        ...
        <div style={styles.overlay}>
          <div style={styles.overlayContent}>
            ...
            <p style={styles.overlayText}>
              For security reasons and optimal functionality, please access the Super Admin portal from a desktop or tablet device.
            </p>
          </div>
        </div>
      )}
      ...
      <div style={styles.leftSection}>
        <div style={styles.leftSectionWrapper}>
          <div style={styles.titleBlock}>
            <h1 style={styles.title}>Super Admin Portal</h1>
      ...
      <div style={styles.rightSection}>
        ...
        <p style={styles.welcomeSubtitle}>
          Access the complete administrative dashboard to manage banking operations, 
          monitor loan portfolios, and oversee system security.
        </p>
        
        <div style={styles.securityBadge}>
          <FaShieldAlt size={20} color="rgba(255, 255, 255, 0.9)" />
